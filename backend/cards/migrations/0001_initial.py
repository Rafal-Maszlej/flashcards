    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='cards.FlashCardCategory')),
            ],
        ),
        migrations.AddField(
            model_name='flashcardanswer',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='cards.FlashCardQuestion'),
        ),
    ]
