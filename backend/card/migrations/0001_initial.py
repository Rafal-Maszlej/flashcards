# Generated by Django 2.1.4 on 2019-01-15 20:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='card.CardCategory')),
            ],
        ),
        migrations.AddField(
            model_name='cardanswer',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='card.CardQuestion'),
        ),
    ]
